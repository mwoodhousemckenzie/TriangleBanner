...
if(programmableCanvas.getAttribute("alternate")!=null){var altInput=('true'==programmableCanvas.getAttribute("alternate"));alternate=altInput}
...
if(programmableCanvas.getAttribute("direction")!=null){var tempDir=parseInt(programmableCanvas.getAttribute("direction"));if(!isNaN(tempDir)){if(tempDir==1){direction=1}}}
...
if(programmableCanvas.getAttribute("animationDelay")!=null){var animDelay=parseInt(programmableCanvas.getAttribute("animationDelay"));if(!isNaN(animDelay)){animationDelay=animDelay}}}
...
var hasFinishedX=!1;var hasFinishedY=!1;var currentXFromOrigin=0;var currentYFromOrigin=0;var waiting=!1;var AnimationMoveRandom=function(){if(!hasStarted){goToAmountX=Random(-50,50);goToAmountY=Random(-50,50);currentXFromOrigin+=goToAmountX;currentYFromOrigin+=goToAmountY;hasStarted=!0}
if(Math.round(currentAmountX*10)/10==goToAmountX){hasFinishedX=!0;if(animationDelay==0){goToAmountX=Random(-75,75);if(currentXFromOrigin>0){if(currentXFromOrigin+goToAmountX>50){goToAmountX=currentXFromOrigin*-1}else{currentXFromOrigin+=goToAmountX}}else{if(currentXFromOrigin+goToAmountX<-50){goToAmountX=currentXFromOrigin*-1}else{currentXFromOrigin+=goToAmountX}}}}
if(Math.round(currentAmountY*10)/10==goToAmountY){hasFinishedY=!0;if(animationDelay==0){goToAmountY=Random(-75,75);if(currentYFromOrigin>0){if(currentYFromOrigin+goToAmountY>50){goToAmountY=currentYFromOrigin*-1}else{currentYFromOrigin+=goToAmountY}}else{if(currentYFromOrigin+goToAmountY<-50){goToAmountY=currentYFromOrigin*-1}else{currentYFromOrigin+=goToAmountY}}}}
if(hasFinishedX&&hasFinishedY&&!waiting){if(animationDelay!=0){waiting=!0;hasFinishedY=!1;hasFinishedX=!1;setTimeout(function(){goToAmountX=Random(-50,50);goToAmountY=Random(-50,50);if(currentXFromOrigin>0){if(currentXFromOrigin+goToAmountX>50){goToAmountX=currentXFromOrigin*-1}else{currentXFromOrigin+=goToAmountX}}else{if(currentXFromOrigin+goToAmountX<-50){goToAmountX=currentXFromOrigin*-1}else{currentXFromOrigin+=goToAmountX}}
if(currentYFromOrigin>0){if(currentYFromOrigin+goToAmountY>50){goToAmountY=currentYFromOrigin*-1}else{currentYFromOrigin+=goToAmountY}}else{if(currentYFromOrigin+goToAmountY<-50){goToAmountY=currentYFromOrigin*-1}else{currentYFromOrigin+=goToAmountY}}
waiting=!1},animationDelay)}}
if(!waiting){if(!hasFinishedX){if(currentAmountX>goToAmountX){currentAmountX-=0.5}else{currentAmountX+=0.5}}
if(!hasFinishedY){if(currentAmountY>goToAmountY){currentAmountY-=0.5}else{currentAmountY+=0.5}}
for(var x=0;x<nodePoints.length;x++){for(var y=0;y<nodePoints[x].length;y++){if(!hasFinishedX){if(currentAmountX>goToAmountX){nodePoints[x][y].x-=0.5}else{nodePoints[x][y].x+=0.5}}
if(!hasFinishedY){if(currentAmountY>goToAmountY){nodePoints[x][y].y-=0.5}else{nodePoints[x][y].y+=0.5}}}}}}
var setupAnimations=!1;var xStart,xEnd,xInc;var yStart,yEnd,yInc;var waveInc;var AnimationMoveWave=function(){if(!waiting){if(nodeModifiedCount>=nodeCount){waiting=!0;setTimeout(function(){if(alternate){direction=direction*-1;setupAnimations=!1}
if(direction==1){currentWaveMain=width+maxNodeWidth*3}else{currentWaveMain=maxNodeWidth*-1.5}
nodeModifiedCount=1;waiting=!1},animationDelay)}
if(!setupAnimations){if(direction==1){xEnd=-1;xStart=nodePoints.length-1;xInc=-1
waveInc=-1}else{xStart=0;xEnd=nodePoints.length;xInc=1;waveInc=1}
setupAnimations=!0}
for(var x=xStart;x!=xEnd;x+=xInc){if(direction==1){yEnd=-1;yStart=nodePoints[x].length-1;yInc=-1}else{yStart=0;yEnd=nodePoints[x].length;yInc=1}
for(var y=yStart;y!=yEnd;y+=yInc){if(nodePoints[x][y].animating){if(nodePoints[x][y].anim==0){if(Math.round(nodePoints[x][y].animCount*10)/10<maxPeak){nodePoints[x][y].anim=1}else{nodePoints[x][y].y-=speed;nodePoints[x][y].animCount-=speed}}else if(nodePoints[x][y].anim==1){if(Math.round(nodePoints[x][y].animCount*10)/10>0){nodePoints[x][y].anim=2}else{nodePoints[x][y].y+=speed;nodePoints[x][y].animCount+=speed}}else{nodePoints[x][y].animating=!1;nodePoints[x][y].animCount=0;nodePoints[x][y].anim=0;nodeModifiedCount+=1}}else if(Math.floor(nodePoints[x][y].x)==Math.floor(currentWaveMain)){nodePoints[x][y].animating=!0}}}
currentWaveMain+=waveInc}}
var AnimationMoveWaveWithColorChange=function(){if(!waiting){if(nodeModifiedCount>=nodeCount){waiting=!0;setTimeout(function(){if(alternate){direction=direction*-1;setupAnimations=!1}
if(direction==1){currentWaveMain=width+maxNodeWidth*3}else{currentWaveMain=maxNodeWidth*-1.5}
if(currentColor==0){currentColor=1}else{currentColor=0}
nodeModifiedCount=1;waiting=!1},animationDelay)}
if(!setupAnimations){if(direction==1){xEnd=-1;xStart=nodePoints.length-1;xInc=-1
waveInc=-1}else{xStart=0;xEnd=nodePoints.length;xInc=1;waveInc=1}
setupAnimations=!0}
...
currentWaveMain+=waveInc}}
var AnimationColorChange=function(){if(!waiting){if(nodeModifiedCount>=nodeCount){waiting=!0;setTimeout(function(){if(alternate){direction=direction*-1;setupAnimations=!1}
if(direction==1){currentWaveMain=width+maxNodeWidth*3}else{currentWaveMain=maxNodeWidth*-1.5}
if(currentColor==0){currentColor=1}else{currentColor=0}
nodeModifiedCount=1;waiting=!1},animationDelay)}
if(!setupAnimations){if(direction==1){xEnd=-1;xStart=nodePoints.length-1;xInc=-1
...
currentWaveMain+=waveInc}}
var AnimationColorChangeWave=function(){if(!waiting){if(nodeModifiedCount>=nodeCount){waiting=!0;setTimeout(function(){if(alternate){direction=direction*-1;setupAnimations=!1}
if(direction==1){currentWaveMain=width+maxNodeWidth*3}else{currentWaveMain=maxNodeWidth*-1.5}
if(currentColor==0){currentColor=1}else{currentColor=0}
nodeModifiedCount=1;waiting=!1},animationDelay)}
if(!setupAnimations){if(direction==1){xEnd=-1;xStart=nodePoints.length-1;xInc=-1
...
currentWaveMain+=waveInc}}
var AnimationColorChangeWaveNoFade=function(){if(!waiting){if(nodeModifiedCount>=nodeCount){waiting=!0;setTimeout(function(){if(alternate){direction=direction*-1;setupAnimations=!1}
if(direction==1){currentWaveMain=width+maxNodeWidth*3}else{currentWaveMain=maxNodeWidth*-1.5}
if(currentColor==0){currentColor=1}else{currentColor=0}
nodeModifiedCount=1;waiting=!1},animationDelay)}
if(!setupAnimations){if(direction==1){xEnd=-1;xStart=nodePoints.length-1;xInc=-1
...
var setUpResize=function(){programmableCanvas=document.getElementById(id);if(programmableCanvas.getAttribute("quality")!=null){var style=programmableCanvas.getAttribute("quality");switch(style){case "low":height=programmableCanvas.parentNode.scrollHeight/4;width=programmableCanvas.parentNode.scrollWidth/4;break;case "med":height=programmableCanvas.parentNode.scrollHeight/2;width=programmableCanvas.parentNode.scrollWidth/2;break;case "high":height=programmableCanvas.parentNode.scrollHeight;width=programmableCanvas.parentNode.scrollWidth;break;case "ultra":height=programmableCanvas.parentNode.scrollHeight*2;width=programmableCanvas.parentNode.scrollWidth*2;break;default:height=programmableCanvas.parentNode.scrollHeight;width=programmableCanvas.parentNode.scrollWidth;break}}else{height=programmableCanvas.parentNode.scrollHeight;width=programmableCanvas.parentNode.scrollWidth}
programmableCanvas.style.width='100%';programmableCanvas.style.height='100%';programmableCanvas.width=width;programmableCanvas.height=height;nodePoints=[];maxAllowed=0;currentColor=0;setupAnimations=!1;setUpNodePoints()}
SetUpCanvas()}